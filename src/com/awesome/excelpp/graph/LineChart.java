...
public class LineChart extends JFrame{
	 ...
	 */
	public LineChart(SpreadSheet sheet, int[] rows, int[] columns, String mainTitle, String titleX, String titleY, boolean headers) throws CellInputException, CellDataException{
		super("LineChart");
