...
\begin{description}
	...
	\item JFreechart
		\begin{description}
			...
			\item[+] Een standaard chart heeft al veel basis functionaliteiten.
		\end{description}
\end{description}

Toen we begonnen met de implementatie van grafieken was er niet veel tijd meer over. We hadden dus een library nodig die makkelijk te begrijpen was want dit zorgt voor een snellere implementatie met minder kans op bugs die nadien nog opgelost moeten worden. Zowel JFreechart als BIRT bevatten alle functionaliteiten die Excel++ nodig heeft, maar we vonden dat JFreechart makkelijker te begrijpen was en kozen dus voor JFreechart. Bovendien heeft een standaard chart van JFreechart veel meer functionaliteiten dan die van BIRT (zonder hiervoor code te moeten schrijven heb je al een optie menu, save as PNG, zoom in/out, ...).
